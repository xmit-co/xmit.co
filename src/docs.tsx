  ...
  return (
    <div class="with-header">
      ...
      <div class="body docs">
        ...
        <ul>
          <li>
            Install with <code>go install github.com/xmit-co/xmit@latest</code>;
          </li>
          <li>
        ...
        <ul>
          <li>
            Install <a href="https://brew.sh/">brew</a> if you haven't already;
          </li>
          <li>
        ...
        <h2>⚙️ Single Page Application</h2>
        <p>
